...
import { structureReportSchema, navigationGraphSchema, type NavigationGraph, type StructureReport } from "@demopilot/contracts";
...
export async function discoverCommand(outDir = "artifacts") {
  ...
  const structureReport: StructureReport = {
    ...
    notes: [
      "Generated by demopilot discover.",
      "Use this report as context for the webapp-flow-learner skill."
    ]
  };
